...
nep_list = get_region_ts('Ethiopia', tas_djf)
plot_spagetti(nep_list, axs[0])
axs[0].set_ylabel('Temp, *C')
axs[0].set_title('Ethiopia')
north_list = get_region_ts('Ethiopia_hi', tas_djf)
plot_spagetti(north_list, axs[1])
axs[1].set_title('Highlands')
south_list = get_region_ts('Ethiopia_lo', tas_djf)
plot_spagetti(south_list, axs[2])
axs[2].set_title('Lowlands')
for ax in axs:
    ax.set_ylim([-.5, 3])

plt.tight_layout()
plt.savefig('Ethiopia_tas_djf_ts.png')
...
future_maps(cube_mid, cube_end, np.linspace(-2, 2, 20), reg['Ethiopia'], axs)
for ax in axs:
    ax.plot([40, 40], [3, 17], 'k')

plt.savefig('Ethiopia_tas_djf_map.png')
...
plt.tight_layout()
plt.savefig('Ethiopia_tas_jja_ts.png')
...
plt.savefig('Ethiopia_tas_jja_map.png')
...
plt.tight_layout()
plt.savefig('Ethiopia_tasmax_jja_ts.png')
...
plt.savefig('Ethiopia_tasmax_jja_map.png')
...
fig, axs = plt.subplots(1, 3, figsize=(8, 3))
# change plot size (so no resizing at end)
nep_list = get_region_ts('Ethiopia', pr)
plot_spagetti(nep_list, axs[0])
axs[0].set_ylabel('Pr, mm')
axs[0].set_title('Ethiopia')
nep_list = get_region_ts('Ethiopia_hi', pr)
plot_spagetti(nep_list, axs[1])
axs[1].set_title('Highlands')
nep_list = get_region_ts('Ethiopia_lo', pr)
...
plt.tight_layout()
plt.savefig('Ethiopia_pr_jja_ts.png')
...
plt.savefig('Ethiopia_pr_jja_map.png')
...
plt.tight_layout()
plt.savefig('Ethiopia_pr2_jja_ts.png')
...
cube_end = x_end - x_now
fig, axs = plt.subplots(1, 2, subplot_kw={'projection': ccrs.PlateCarree()}, figsize=(6,3))
future_maps(cube_mid, cube_end, np.linspace(-4, 4, 20), reg['Ethiopia'], axs)
for ax in axs:
    ax.plot([29, 35], [1, 1], 'k')

plt.savefig('Ethiopia_pr2_jja_map.png')
